...
});return l}function init_device(){var e=$("#activityIndicator");log("init_device()"),deviceVars.scrollProperty="top",deviceVars.scrollValue="$1px",$navBar=$("#navBoxHeader"),activityIndicatorTop=Math.floor($(window).height()/2),e.css("top",activityIndicatorTop),$("#startUp-initDevice").addClass("success")
...
return M(e,function(e){t=A.random(r++),n[r-1]=n[t],n[t]=e}),n};var x=function(e){return A.isFunction(e)?e:function(t){return t[e]
}};A.sortBy=function(e,t,r){var n=x(t);return A.pluck(A.map(e,function(e,t,i){return{value:e,index:t,criteria:n.call(r,e,t,i)}
}).sort(function(e,t){var r=e.criteria,n=t.criteria;if(r!==n){if(r>n||void 0===r)return 1;
if(n>r||void 0===n)return-1}return e.index<t.index?-1:1}),"value")};var _=function(e,t,r,n){var i={},a=x(t||A.identity);
return M(e,function(t,o){var s=a.call(r,t,o,e);n(i,s,t)}),i};A.groupBy=function(e,t,r){return _(e,t,r,function(e,t,r){(A.has(e,t)?e[t]:e[t]=[]).push(r)
})},A.countBy=function(e,t,r){return _(e,t,r,function(e,t){A.has(e,t)||(e[t]=0),e[t]++
})},A.sortedIndex=function(e,t,r,n){r=null==r?A.identity:x(r);for(var i=r.call(n,t),a=0,o=e.length;o>a;){var s=a+o>>>1;
...
}),"0".split(void 0,0).length){var x=String.prototype.split;String.prototype.split=function(e,t){return void 0===e&&0===t?[]:x.apply(this,arguments)
}}if("".substr&&"b"!=="0b".substr(-1)){var _=String.prototype.substr;String.prototype.substr=function(e,t){return _.call(this,0>e?0>(e=this.length+e)?0:e:e,t)
...
return r.hideLocationBar=function(){e.scrollTo(0,1)},r.prepareView=function(r){var n=new t.Deferred,i=t(".view:visible").not(r[0]),a=t("#navBoxHeader");
return MyAnswers.dispatch.add(function(){r.hide(),r.css({"z-index":0,position:"absolute"}),i.css({"z-index":50,position:"absolute"}),currentMasterCategory?r.attr({"data-name":siteVars.config["m"+currentMasterCategory].pertinent.name}):t("#categoriesView").removeAttr("data-name"),currentCategory?r.attr({"data-name":siteVars.config["c"+currentCategory].pertinent.name}):t("#keywordListView").removeAttr("data-name"),currentInteraction?r.attr({"data-name":siteVars.config["i"+currentInteraction].pertinent.name,"data-type":siteVars.config["i"+currentInteraction].pertinent.type}):(t("#answerView").removeAttr("data-name"),t("#answerView").removeAttr("data-type")),r.show(),"screen-bottom"!==e.currentConfig.footerPosition&&MyAnswers.$body.children("footer").hide(),a.find("button").prop("disabled",!0),n.resolve()
}),n.promise()},r.showView=function(e,n){var i=new t.Deferred,a=t(".view:visible").not(e[0]),o=n?"right":"left";
return r.hideLocationBar(),MyAnswers.dispatch.add(function(){0!==a.size()?a.hide("slide",{direction:o},300,function(){a.css("z-index",""),a.css("position",""),e.css("z-index",""),e.css("position",""),updateNavigationButtons(),MyAnswers.$body.children("footer").show(),i.resolve(),e.trigger("viewShow")
...
}function r(){var t=new T.Deferred,r=null,n=function(e){r=null,x.notification.alert("Database installed, please restart the App.",function(){x.gap_database.requestTerminate()
...
log("fixWebSQL(): allocatedSpace="+i+" currentQuota="+a),M.device.storageQuota>a?x.gap_database.increaseQuota(n,t.reject,r):t.resolve()
...
try{r=e.openDatabase(C.answerSpace,"1.0",C.answerSpace,1048576),x.gap_database.getLimits(i,t.reject,null)
...
}).always(function(){T.when(requestLoginStatus()).always(function(){T.when(requestConfig()).always(function(){C.map&&C.config?(processConfig(),d(),Modernizr.orientation&&_.on("orientationchange",c),_.on("resize",c),c()):k.append("error: unable to contact server, insufficient data found in local storage")
...
}}function h(){var t,i,a=null,o=[],s=x.userAgent;if(log("init_main(): "),C.requestsCounter=0,PictureSourceType.PHOTO_LIBRARY=0,PictureSourceType.CAMERA=1,lastPictureTaken.image=new Hashtable,lastPictureTaken.currentName=null,T.fx.interval=27,M.dispatch=new BlinkDispatch(isBlinkGapDevice()?149:47),M.runningTasks=0,RegExp.quote=function(e){return e.replace(/([.?*+\^$\[\]\\(){}\-])/g,"\\$1")
...
}),_Blink.isPhantomJS||(_.bind("online",u),_.bind("offline",u),u()),isBlinkGapDevice()?(a=null,t=x.gap_database&&-1!==T.inArray("websqldatabase",BlinkStorage.prototype.available)?r():!0):-1!==s.indexOf("Android")&&(a="sessionstorage"),isBlinkGapDevice()&&M.device.domainWhitelist&&e.navigator.whitelistmanage&&(i=M.device.domainWhitelist,"array"===T.type(i))){log("BlinkGap: replacing domain whitelist...");
try{x.whitelistmanage.appendToWhitelist(T.noop,T.noop,{externalHosts:i})}catch(c){log("BlinkGap: domain whitelist error..."),error(c)
...
e.length>=1&&(e[0]=i(e[0])),e.length>=3&&(e[2]=i(e[2])),w.apply(m,e)},log("domain="+C.serverDomain+" branch="+C.serverAppBranch+" version="+C.serverAppVersion+" device="+A.device),C.serverAppPath="/_"+C.serverAppBranch+"_/common/"+C.serverAppVersion,C.serverDevicePath="/_"+C.serverAppBranch+"_/"+A.device+"/"+C.serverAppVersion,C.queryParameters=getURLParameters(),delete C.queryParameters.uid,delete C.queryParameters.answerSpace,M.$html=T("html"),M.$body=M.$html.children("body"),M.$document=T(e.document),M.$window=_,M.$footer=M.$body.children("footer"),_.on("statechange",function(e){var t=m.getState(),r=t.data.arguments;
...
}}var m,v,w,b,S=e.document,C=e.siteVars,A=e.deviceVars,M=e.MyAnswers,T=e.jQuery,k=T("#startUp"),x=e.navigator,_=T(e);
...
return Modernizr.geolocation?(e=T.extend({},r,T.isPlainObject(e)?e:{}),x.geolocation.getCurrentPosition(function(e){var r;
...
}).fail(function(){log("init failed, not all promises kept")}),T(S).ready(function(){var t,r=x.userAgent;
...
//@ sourceMappingURL=/_R_/msie/3/bic2.js.map