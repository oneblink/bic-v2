...
for(r=16;79>=r;r++)f[r]=l(f[r-3]^f[r-8]^f[r-14]^f[r-16],1);for(i=d,o=g,a=h,s=y,u=m,r=0;19>=r;r++)c=4294967295&l(i,5)+(o&a|~o&s)+u+f[r]+1518500249,u=s,s=a,a=l(o,30),o=i,i=c;
for(r=20;39>=r;r++)c=4294967295&l(i,5)+(o^a^s)+u+f[r]+1859775393,u=s,s=a,a=l(o,30),o=i,i=c;
for(r=40;59>=r;r++)c=4294967295&l(i,5)+(o&a|o&s|a&s)+u+f[r]+2400959708,u=s,s=a,a=l(o,30),o=i,i=c;
for(r=60;79>=r;r++)c=4294967295&l(i,5)+(o^a^s)+u+f[r]+3395469782,u=s,s=a,a=l(o,30),o=i,i=c;
d=4294967295&d+i,g=4294967295&g+o,h=4294967295&h+a,y=4294967295&y+s,m=4294967295&m+u
}return c=p(d)+p(g)+p(h)+p(y)+p(m),c.toLowerCase()}function urldecode(e){return decodeURIComponent((e+"").replace(/\+/g,"%20"))
...
var l="http://www.w3.org/1999/xhtml",p="http://www.w3.org/XML/1998/namespace";o.getElementsByTagNameNS&&o.getElementsByTagNameNS(l,"html")[0]?o.getElementsByTagNameNS(l,"html")[0].getAttributeNS&&o.getElementsByTagNameNS(l,"html")[0].getAttributeNS(p,"lang")?c.locale=o.getElementsByTagName(l,"html")[0].getAttributeNS(p,"lang"):o.getElementsByTagNameNS(l,"html")[0].lang&&(c.locale=o.getElementsByTagNameNS(l,"html")[0].lang):o.getElementsByTagName("html")[0]&&o.getElementsByTagName("html")[0].lang&&(c.locale=o.getElementsByTagName("html")[0].lang)
...
});return l}function init_device(){var e=$("#activityIndicator");log("init_device()"),deviceVars.scrollProperty="-moz-transform",deviceVars.scrollValue="translateY($1px)",$navBar=$("#navBoxHeader"),activityIndicatorTop=Math.floor($(window).height()/2),e.css("top",activityIndicatorTop),$("#startUp-initDevice").addClass("success")
}function PictureSourceType(){}function lastPictureTaken(){}function isCameraPresent(){var e=isBlinkGapDevice();
...
var t,r,n,i,o,a,s,u,c=new $.Deferred,l=new $.Deferred,p=currentConfig.xsl,f=function(e,r){t+="<"+e+">"+r+"</"+e+">"
},d=function(e){s+=" or "+a+"='"+e+"'"};if("string"!==$.type(p)||0===p.length)return c.reject("<p>Error: this Interaction does not have any XSL to transform.</p>"),c.promise();
if(e)for(r=p.match(/\$args\[[\w\:][\w\:\-\.]*\]/g),i=r?r.length:0,n=0;i>n;n++)o="string"==typeof e[r[n].substring(1)]?e[r[n].substring(1)]:"",o=o.replace('"',""),o=o.replace("'",""),o=decodeURIComponent(o),p=p.replace(r[n],o);
for(u=p.match(/blink-stars\(([@\w.]+),\W*(\w+)\W*\)/);u;)s="",a=u[1],u=u[2],"object"===$.type(starsProfile[u])&&($.each(starsProfile[u],d),s=s.substr(4)),p=s.length>0?p.replace(/\(?blink-stars\(([@\w.]+),\W*(\w+)\W*\)\)?/,"("+s+")"):p.replace(/\(?blink-stars\(([@\w.]+),\W*(\w+)\W*\)\)?/,"(false())"),u=p.match(/blink-stars\(([@\w.]+),\W*(\w+)\W*\)/);
return"string"===$.type(currentConfig.xml)&&0===currentConfig.xml.indexOf("stars:")&&(currentConfig.mojoType="stars",currentConfig.xml=currentConfig.xml.replace(/^stars:/,"")),"stars"===currentConfig.mojoType?(u=currentConfig.xml,t="","object"!==$.type(starsProfile[u])?t="<stars></stars>":($.each(starsProfile[u],function(e,r){t+="<"+u+' id="'+e+'">',$.each(r,f),t+="</"+u+">"
...
}):(t="<xml />",setTimeout(l.resolve,0)),"pending"!==c.state()?c.promise():($.when(l).always(function(){$.when(performXSLT(t,p)).done(function(e){c.resolve(e)
...
}).then(function(r,n){var i=[],o=function(e,r,n){var o,a=r.split(":"),s=siteVars.config["i"+a[0]],u=s?s.pertinent.name:"* unknown *",c=s?s.pertinent.displayName||s.pertinent.name:"* unknown *",l=a[1],p=a[2],f="";
f+="<id>"+r+"</id>\n",f+="<interaction>"+u+"</interaction>\n",f+="<interactionLabel>"+c+"</interactionLabel>\n",f+="<uuid>"+p+"</uuid>\n",f+="<form>"+l+"</form>\n",f+="<blinkFormsVersion>"+n+"</blinkFormsVersion>\n",2===n?(o=MyAnswers.pendingStore.get(r),i.push(o.promise()),$.when(o).fail(function(){t+="<record>"+f+"</record>\n"
...
}function updateNavigationButtons(){var e=MyAnswers.device.persistentStorage;MyAnswers.dispatch.add(function(){try{var t,r,n,i,o=$(".navBar"),a=$("#homeButton, #backButton"),s=$("#helpButton"),u=$("#pendingButton"),c=siteVars.hasLogin,l=window.isHome(),p=l||MyAnswers.isEmptySpace||MyAnswers.isLoginOnly;
...
break;case"helpView":t=null;break;default:t=siteVars.config["a"+siteVars.id]}r="string"==typeof t,r?(s.show(),s.removeAttr("disabled")):s.hide(),i=u.length>0&&p?countPendingForms():!0,$.when(i).always(function(e){"number"!=typeof e&&(e=0),n=p&&!c&&!r&&!e,n?o.hide():p?(o.show(),a.hide()):(a.show(),a.prop("disabled",!1),o.show())
...
return t.add(function(){var t,o,a=$(r),s=a.tag(),u="formXML:"+e+":"+s,c=a.children(),l=c.length,p="";
if(-1!==i.indexOf(a.tag())){for(t=0;l>t;t++)o=_Blink.stringifyDOM(c[t]),o&&(p+=o);
$.when(MyAnswers.store.set(u,p)).fail(function(){warn("processForms()->formActionFn(): failed storing "+u),n.reject()
...
$.when(MyAnswers.pendingStore.keys(),MyAnswers.pendingV1Store.keys()).then(function(t,o){var a=(t.length+o.length,function(e,t,r){var n,i=r.data("blinkFormVersion"),o=r.children(".template"),a=o.clone(),s=t.split(":"),u=siteVars.config["i"+s[0]],c=u?u.pertinent.displayName||u.pertinent.name:"* unknown *",l=s[1],p=s[2];
a.children("h3").text(c),a.children("pre.uuid").text(p),a.attr("data-id",t),2===i&&$.when(MyAnswers.pendingStore.get(t)).then(function(e){"string"==typeof e&&0!==e.length&&("object"!==$.type(e)&&(e=$.parseJSON(e)),"array"===$.type(e)&&(n=a.children("dl"),$.each(e[1],function(e,t){n.append("<dt>"+e+"</dt><dd>"+t+"</dd>")
...
}).always(function(){insertHTML(s,n),u()});else{var o=siteVars.serverAppPath+"/xhr/GetAnswer.php",a={asn:siteVars.answerSpace,iact:currentConfig.name},p=function(){c?$.when(MyAnswers.store.get("answer___"+e)).done(function(e){e===void 0&&(e="<p>Unable to reach server, and unable to display previously stored content.</p>"),insertHTML(s,e),u()
}):(n="<p>Unable to reach server.</p>",insertHTML(s,n),u())},f={},d={},g="GET";$.isEmptyObject(i)||$.extend(a,i),a._submitStarsType&&(g="POST","string"===$.type(a._submitStarsType)&&(a._submitStarsType=[a._submitStarsType]),"array"===$.type(a._submitStarsType)&&$.each(a._submitStarsType,function(e,t){d[t]=starsProfile[t]||{}
}),f[a._submitStarsPost||"stars"]=d,delete a._submitStarsPost,delete a._submitStarsType,o+="?"+$.param(a),a=f),$.ajax({type:g,url:o,data:a,complete:function(t,r){if("timeout"===r)insertHTML(s,"Error: the server has taken too long to respond.  ("+r+" "+t.status+")"),u();
...
var r,n,i,o=$(".view:visible,"),a=o.children(".box"),s=a.find("form").first(),u=s.find("input[type=submit]"),c=s.find("input[name=blink_session_data]"),l="cancel=Cancel"===t?"":s.find("input, textarea, select").serialize(),p=s.attr("method");
return 1===u.length&&u.attr("name")&&u.val()&&(l+="&"+u.attr("name")+"="+u.val()),1!==c.size()||$.isEmptyObject(starsProfile)||(i='{"stars":'+JSON.stringify(starsProfile)+"}",l=l.replace("blink_session_data=","blink_session_data="+encodeURIComponent(i)),p="post"),"string"===$.type(p)&&"get"===p.toLowerCase()?(p="GET",n=siteVars.serverAppPath+"/xhr/GetAnswer.php?asn="+siteVars.answerSpace+"&iact="+e,r="&"+l+("string"==typeof t&&t.length>0?"&"+t:"")):(p="POST",n=siteVars.serverAppPath+"/xhr/GetAnswer.php?asn="+siteVars.answerSpace+"&iact="+e+("string"==typeof t&&t.length>0?"&"+t:""),r=l),MyAnswers.$body.trigger("taskBegun"),$.ajax({type:p,cache:"false",url:n,data:r,complete:function(e,t){var r,n,i,s;
...
o.busy(!0);var s=o.createStateObject(r,n,i),u=o.getHashByState(s),c=o.getState(!1),l=o.getHashByState(c),p=o.getHash();
return o.storeState(s),o.expectedStateId=s.id,o.recycleState(s),o.setTitle(s),u===l?(o.busy(!1),!1):u!==p&&u!==o.getShortUrl(t.location.href)?(o.setHash(u,!1),!1):(o.saveState(s),o.Adapter.trigger(e,"statechange"),o.busy(!1),!0)
...
}),void 0)},o.init!==void 0&&o.init()}(window),function(e,t){"use strict";var r=e.console||t,n=e.document,i=e.navigator,o=e.sessionStorage||!1,a=e.setTimeout,s=e.clearTimeout,u=e.setInterval,c=e.clearInterval,l=e.JSON,p=e.alert,f=e.History=e.History||{},d=e.history;
...
if(t!==void 0&&null!==t){for(e=0;t.length>e;e++)c(t[e]);f.intervalList=null}},f.debug=function(){(f.options.debug||!1)&&f.log.apply(f,arguments)
},f.log=function(){var e,t,i,o,a,s=r!==void 0&&r.log!==void 0&&r.log.apply!==void 0,u=n.getElementById("log");
...
}catch(c){}e+="\n"+a+"\n"}return u?(u.value+=e+"\n-----\n",u.scrollTop=u.scrollHeight-u.clientHeight):s||p(e),!0
...
},f.setHash=function(e,t){var r,i,o;return t!==!1&&f.busy()?(f.pushQueue({scope:f,callback:f.setHash,args:arguments,queue:t}),!1):(r=f.escapeHash(e),f.busy(!0),i=f.extractState(e,!0),i&&!f.emulated.pushState?f.pushState(i.data,i.title,i.url,!1):n.location.hash!==r&&(f.bugs.setHash?(o=f.getPageUrl(),f.pushState(null,null,o+"#"+r,!1)):n.location.hash=r),f)
...
var t=function(){var e,r,n;if(!f.busy.flag)for(e=f.queues.length-1;e>=0;--e)r=f.queues[e],0!==r.length&&(n=r.shift(),f.fireQueueItem(n),f.busy.timeout=a(t,f.options.busyDelay))
};f.busy.timeout=a(t,f.options.busyDelay)}return f.busy.flag},f.busy.flag=!1,f.fireQueueItem=function(e){return e.callback.apply(e.scope||f,e.args||[])
...
},f.doubleCheck=function(e){return f.stateChanged=!1,f.doubleCheckClear(),f.bugs.ieDoubleCheck&&(f.doubleChecker=a(function(){return f.doubleCheckClear(),f.stateChanged||e(),!0
...
}else f.onPopState=function(t,r){var i,o,a=!1,s=!1;return f.doubleCheckComplete(),i=f.getHash(),i?(o=f.extractState(i||n.location.href,!0),o?f.replaceState(o.data,o.title,o.url,!1):(f.Adapter.trigger(e,"anchorchange"),f.busy(!1)),f.expectedStateId=!1,!1):(a=f.Adapter.extractEventData("state",t,r)||!1,s=a?f.getStateById(a):f.expectedStateId?f.getStateById(f.expectedStateId):f.extractState(n.location.href),s||(s=f.createStateObject(null,null,n.location.href)),f.expectedStateId=!1,f.isLastSavedState(s)?(f.busy(!1),!1):(f.storeState(s),f.saveState(s),f.setTitle(s),f.Adapter.trigger(e,"statechange"),f.busy(!1),!0))
...
f.busy(!0);var o=f.createStateObject(t,r,n);return f.isLastSavedState(o)?f.busy(!1):(f.storeState(o),f.expectedStateId=o.id,d.pushState(o.id,o.title,o.url),f.Adapter.trigger(e,"popstate")),!0
...
f.busy(!0);var o=f.createStateObject(t,r,n);return f.isLastSavedState(o)?f.busy(!1):(f.storeState(o),f.expectedStateId=o.id,d.replaceState(o.id,o.title,o.url),f.Adapter.trigger(e,"popstate")),!0
};if(o){try{f.store=l.parse(o.getItem("History.store"))||{}}catch(h){f.store={}}f.normalizeStore()
}else f.store={},f.normalizeStore();f.Adapter.bind(e,"beforeunload",f.clearAllIntervals),f.Adapter.bind(e,"unload",f.clearAllIntervals),f.saveState(f.storeState(f.extractState(n.location.href,!0))),o&&(f.onUnload=function(){var e,t;
...
f.store=e,f.normalizeStore(),o.setItem("History.store",l.stringify(e))},f.intervalList.push(u(f.onUnload,f.options.storeInterval)),f.Adapter.bind(e,"beforeunload",f.onUnload),f.Adapter.bind(e,"unload",f.onUnload)),f.emulated.pushState||(f.bugs.safariPoll&&f.intervalList.push(u(f.safariStatePoll,f.options.safariPollInterval)),("Apple Computer, Inc."===i.vendor||"Mozilla"===(i.appCodeName||""))&&(f.Adapter.bind(e,"hashchange",function(){f.Adapter.trigger(e,"popstate")
}),f.getHash()&&f.Adapter.onDomLoad(function(){f.Adapter.trigger(e,"hashchange")})))
},f.init()}(window),function(){var e=this,t=e._,r={},n=Array.prototype,i=Object.prototype,o=Function.prototype,a=n.push,s=n.slice,u=n.concat,c=i.toString,l=i.hasOwnProperty,p=n.forEach,f=n.map,d=n.reduce,g=n.reduceRight,h=n.filter,y=n.every,m=n.some,v=n.indexOf,w=n.lastIndexOf,b=Array.isArray,S=Object.keys,C=o.bind,A=function(e){return e instanceof A?e:this instanceof A?(this._wrapped=e,void 0):new A(e)
...
return null==e?n:f&&e.map===f?e.map(t,r):(M(e,function(e,i,o){n[n.length]=t.call(r,e,i,o)
...
if(M(e,function(e,o,a){i?r=t.call(n,r,e,o,a):(r=e,i=!0)}),!i)throw new TypeError(T);
...
var o=e.length;if(o!==+o){var a=A.keys(e);o=a.length}if(M(e,function(s,u,c){u=a?a[--o]:--o,i?r=t.call(n,r,e[u],u,c):(r=e[u],i=!0)
}),!i)throw new TypeError(T);return r},A.find=A.detect=function(e,t,r){var n;return _(e,function(e,i,o){return t.call(r,e,i,o)?(n=e,!0):void 0
}),n},A.filter=A.select=function(e,t,r){var n=[];return null==e?n:h&&e.filter===h?e.filter(t,r):(M(e,function(e,i,o){t.call(r,e,i,o)&&(n[n.length]=e)
}),n)},A.reject=function(e,t,r){return A.filter(e,function(e,n,i){return!t.call(r,e,n,i)
},r)},A.every=A.all=function(e,t,n){t||(t=A.identity);var i=!0;return null==e?i:y&&e.every===y?e.every(t,n):(M(e,function(e,o,a){return(i=i&&t.call(n,e,o,a))?void 0:r
}),!!i)};var _=A.some=A.any=function(e,t,n){t||(t=A.identity);var i=!1;return null==e?i:m&&e.some===m?e.some(t,n):(M(e,function(e,o,a){return i||(i=t.call(n,e,o,a))?r:void 0
...
if(!t&&A.isEmpty(e))return-1/0;var n={computed:-1/0,value:-1/0};return M(e,function(e,i,o){var a=t?t.call(r,e,i,o):e;
...
return M(e,function(e){t=A.random(r++),n[r-1]=n[t],n[t]=e}),n};var k=function(e){return A.isFunction(e)?e:function(t){return t[e]
}};A.sortBy=function(e,t,r){var n=k(t);return A.pluck(A.map(e,function(e,t,i){return{value:e,index:t,criteria:n.call(r,e,t,i)}
}).sort(function(e,t){var r=e.criteria,n=t.criteria;if(r!==n){if(r>n||void 0===r)return 1;
if(n>r||void 0===n)return-1}return e.index<t.index?-1:1}),"value")};var x=function(e,t,r,n){var i={},o=k(t||A.identity);
return M(e,function(t,a){var s=o.call(r,t,a,e);n(i,s,t)}),i};A.groupBy=function(e,t,r){return x(e,t,r,function(e,t,r){(A.has(e,t)?e[t]:e[t]=[]).push(r)
})},A.countBy=function(e,t,r){return x(e,t,r,function(e,t){A.has(e,t)||(e[t]=0),e[t]++
})},A.sortedIndex=function(e,t,r,n){r=null==r?A.identity:k(r);for(var i=r.call(n,t),o=0,a=e.length;a>o;){var s=o+a>>>1;
...
};var E=function(e,t,r){return M(e,function(e){A.isArray(e)?t?a.apply(r,e):E(e,t,r):r.push(e)
...
return M(i,function(r,n){(t?n&&a[a.length-1]===r:A.contains(a,r))||(a.push(r),o.push(e[n]))
...
}),e},A.pick=function(e){var t={},r=u.apply(n,s.call(arguments,1));return M(r,function(r){r in e&&(t[r]=e[r])
...
for(var p in e)if(A.has(e,p)&&(a++,!(s=A.has(t,p)&&j(e[p],t[p],r,n))))break;if(s){for(p in t)if(A.has(t,p)&&!a--)break;
...
},A.isObject=function(e){return e===Object(e)},M(["Arguments","Function","String","Number","Date","RegExp"],function(e){A["is"+e]=function(t){return c.call(t)=="[object "+e+"]"
...
return a.apply(e,arguments),V.call(this,r.apply(A,e))}})};var $=0;A.uniqueId=function(e){var t=++$+"";
return e?e+t:t},A.templateSettings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g};
var O=/(.)^/,P={"'":"'","\\":"\\","\r":"r","\n":"n","	":"t","\u2028":"u2028","\u2029":"u2029"},B=/\\|'|\r|\n|\t|\u2028|\u2029/g;
A.template=function(e,t,r){var n;r=A.defaults({},r,A.templateSettings);var i=RegExp([(r.escape||O).source,(r.interpolate||O).source,(r.evaluate||O).source].join("|")+"|$","g"),o=0,a="__p+='";
e.replace(i,function(t,r,n,i,s){return a+=e.slice(o,s).replace(B,function(e){return"\\"+P[e]
...
});var i,o,a,s,u,c=Function.prototype.call,l=Array.prototype,p=Object.prototype,f=l.slice,d=c.bind(p.toString),g=c.bind(p.hasOwnProperty);
if((u=g(p,"__defineGetter__"))&&(i=c.bind(p.__defineGetter__),o=c.bind(p.__defineSetter__),a=c.bind(p.__lookupGetter__),s=c.bind(p.__lookupSetter__)),2!=[1,2].splice(0).length){var h=Array.prototype.splice;
...
g(e,o)&&t.push(o)}return t}}var A=-621987552e5,M="-000001";Date.prototype.toISOString&&-1!==new Date(A).toISOString().indexOf(M)||(Date.prototype.toISOString=function(){var e,t,r,n,i;
...
}})}catch(_){}if(T||(Date.prototype.toJSON=function(){var e,t=Object(this),r=n(t);
...
if(i){var o,a=Number(i[1]),s=Number(i[2]||1)-1,u=Number(i[3]||1)-1,c=Number(i[4]||0),l=Number(i[5]||0),p=Number(i[6]||0),f=Number(i[7]||0),d=!i[4]||i[8]?0:Number(new e(1970,0)),g="-"===i[9]?1:-1,h=Number(i[10]||0),y=Number(i[11]||0);
return(l>0||p>0||f>0?24:25)>c&&60>l&&60>p&&1e3>f&&s>-1&&12>s&&24>h&&60>y&&u>-1&&r(a,s+1)-r(a,s)>u&&(o=60*(24*(r(a,s)+u)+c+h*g),o=1e3*(60*(o+l+y*g)+p)+f+d,o>=-864e13&&864e13>=o)?o:0/0
}return e.parse.apply(this,arguments)},t}(Date),Date.now||(Date.now=function(){return(new Date).getTime()
}),"0".split(void 0,0).length){var k=String.prototype.split;String.prototype.split=function(e,t){return void 0===e&&0===t?[]:k.apply(this,arguments)
...
this.put=function(e,t){f(e),d(t);var r,n,s=g(e),c=null;return r=u(a,s),r?(n=r.getEntryForKey(e),n?(c=n[1],n[1]=t):r.addEntry(e,t)):(r=new i(s,e,t,h),o[o.length]=r,a[s]=r),c
},this.get=function(e){f(e);var t=g(e),r=u(a,t);if(r){var n=r.getEntryForKey(e);if(n)return n[1]
}return null},this.containsKey=function(e){f(e);var t=g(e),r=u(a,t);return r?r.containsKey(e):!1
...
var t,r=g(e),n=null,i=u(a,r);return i&&(n=i.removeEntryForKey(e),null!==n&&(i.entries.length||(t=s(o,r),p(o,t),delete a[r]))),n
...
},this.clone=function(){var e=new c(t,r);return e.putAll(n),e}}var l="function",p=typeof Array.prototype.splice==l?function(e,t){e.splice(t,1)
...
}):e.BMP=t(e,e.$)}(this,function(e,t){"use strict";var r,n,i,o,a,s,u=t(e.document),c=t(e.document.body),l=e.navigator||{},p={};
return r=e.BMP=e.BMP||{},t&&t.fn&&"string"==typeof t.fn.jquery?(i=function(){var e=t('<div id="bmp-dialog-async"></div>');
return e.hide(),c.append(e),e},p.jQueryUI=function(e,t){n=c.find("#bmp-dialog-async"),n.length||(n=i()),n.empty(),n.hasClass("ui-dialog-content")&&n.dialog("destroy"),n.append("<p>"+e+"</p>"),t.modal=!0,t.closeOnEscape=!0,n.dialog(t)
...
},n.close=i,p.jQueryUI(r,n)):(r=(n.title?n.title+" | ":"")+r,e.alert(r),a.resolve()),a.promise()
...
},i.close=function(){a.isRejected()&&a.isResolved()||a.resolve(null)},p.jQueryUI(r,i)):(r=(i.title?i.title+" | ":"")+r,a.resolve(e.prompt(r))),a.promise()
...
var t,r,n,i,o,a,s,u,c,l=e.jQuery,p=e.BMP,f=(p.alert,{}),d={},g=function(u,c,d){var g,h,y,m=this,v=new l.Deferred;
...
},n,l.noop)},o=function(){try{h=e.openDatabase(c,"1.0",c,r),f[c]=h,h.readTransaction=h.readTransaction||h.transaction
}catch(t){throw v.reject(),"BlinkStorage: "+t}},g={get:"SELECT v FROM `"+d+"` WHERE k = ?",set:"INSERT OR REPLACE INTO `"+d+"` (k, v) VALUES (?, ?)",remove:"DELETE FROM `"+d+"` WHERE k = ?",keys:"SELECT k FROM `"+d+"`",count:"SELECT count(k) AS `count` FROM "+d},f[c]?h=f[c]:o(),i(),m.get=function(e){var t=new l.Deferred;
...
}(this);var activityIndicatorTop,$navBar,onDeviceReady=$.noop;document.getElementById("startUp-loadDevice").className="working",MyAnswers.deviceDeferred=new $.Deferred,function(e){var t=e.jQuery,r=function(){var r=this;
...
return MyAnswers.dispatch.add(function(){r.hide(),r.css({"z-index":0,position:"absolute"}),i.css({"z-index":50,position:"absolute"}),currentMasterCategory?r.attr({"data-name":siteVars.config["m"+currentMasterCategory].pertinent.name}):t("#categoriesView").removeAttr("data-name"),currentCategory?r.attr({"data-name":siteVars.config["c"+currentCategory].pertinent.name}):t("#keywordListView").removeAttr("data-name"),currentInteraction?r.attr({"data-name":siteVars.config["i"+currentInteraction].pertinent.name,"data-type":siteVars.config["i"+currentInteraction].pertinent.type}):(t("#answerView").removeAttr("data-name"),t("#answerView").removeAttr("data-type")),r.show(),"screen-bottom"!==e.currentConfig.footerPosition&&MyAnswers.$body.children("footer").hide(),o.find("button").prop("disabled",!0),n.resolve()
}),n.promise()},r.showView=function(e,n){var i=new t.Deferred,o=t(".view:visible").not(e[0]),a=n?"right":"left";
return r.hideLocationBar(),MyAnswers.dispatch.add(function(){0!==o.size()?o.hide("slide",{direction:a},300,function(){o.css("z-index",""),o.css("position",""),e.css("z-index",""),e.css("position",""),updateNavigationButtons(),MyAnswers.$body.children("footer").show(),i.resolve(),e.trigger("viewShow")
}):(e.css("z-index",""),e.css("position",""),updateNavigationButtons(),MyAnswers.$body.children("footer").show(),i.resolve(),e.trigger("viewShow"))
}),i.promise()},r};e.MyAnswersDevice=new r}(this),document.getElementById("startUp-loadDevice").className="working success",MyAnswers.deviceDeferred.resolve();
...
o.populateItemListing=function(e,a){var s,u,c,l,p,f,d,g,h,y,m,v,w,b,S,C,A={};A.interactions=function(e){var t=e.attr("data-id"),r=siteVars.config["i"+t].pertinent;
...
},o.dispatch.add(function(){switch(a.children(".box:not(.welcomeBox)").remove(),p=$('<div class="box bordered" />'),f=$('<ul class="box" />'),e){case"masterCategories":s=currentConfig.masterCategoriesArrangement,u=currentConfig.masterCategoriesDisplay,c=siteVars.map.masterCategories,l=c,d="m";
...
}),o.dispatch.add(function(){p.children().size()>0&&(S=p.find("img"),1===b?(S.first().addClass("topLeft topRight"),S.last().addClass("bottomLeft bottomRight")):(S.first().addClass("topLeft"),S.size()>=b&&S.eq(b-1).addClass("topRight"),0===S.size()%b&&(S.eq(-1*b).addClass("bottomLeft"),S.last().addClass("bottomRight"))),p.appendTo(a)),f.children().size()>0&&f.appendTo(a)
...
}function r(){var t=new T.Deferred,r=null,n=function(e){r=null,k.notification.alert("Database installed, please restart the App.",function(){k.gap_database.requestTerminate()
},"First Run","Close App"),log("fixWebSQL(): quota increase: "+e)},i=function(e){var r={quotaIncrease:M.device.storageQuota+""},i=e.allocatedSpace,o=e.currentQuota;
log("fixWebSQL(): allocatedSpace="+i+" currentQuota="+o),M.device.storageQuota>o?k.gap_database.increaseQuota(n,t.reject,r):t.resolve()
...
try{r=e.openDatabase(C.answerSpace,"1.0",C.answerSpace,1048576),k.gap_database.getLimits(i,t.reject,null)
...
})}):e.resolve(),e.promise()}function i(e){var t,r,n,o=T.type(e);return"string"===o&&e.length>0?(t=e.indexOf("#"),-1!==t&&(e=e.substring(0,t))):"array"===o&&e.length>0?(r=[],T.each(e,function(e,t){r.push(i(t))
}),e=r):"object"===o&&(n={},T.each(e,function(e,t){n[e]=i(t)}),e=n),e}function o(e){var t,r=new T.Deferred,n=new b.maps.DirectionsService;
...
}}),r.promise()):(r.reject("GoogleDirections error: bad options"),r.promise())}function a(e,t,r){log("GoogleMaps basic: initialising..."),M.$body.trigger("taskBegun");
...
}))),M.$body.trigger("taskComplete")}function s(e,t,r){var n,i,s,u={},c={travelMode:b.maps.DirectionsTravelMode[t.travelmode.toUpperCase()],avoidHighways:t.avoidhighways,avoidTolls:t.avoidtolls},l={mapTypeId:b.maps.MapTypeId[t.type.toUpperCase()]},p=T(e),f=p.next(".googledirections").first(),d=f,g=!0,h=!0,y=function(e){"string"==typeof e&&e.length>0&&insertText(f[0],e)
...
})),T.when(g,h).always(function(){n&&i?"object"===T.type(n)&&"object"===T.type(i)&&n.equals(i)?(insertText(f[0],"origin and destination are the identical"),t.latitude=n.lat(),t.longitude=n.lng(),a(e,t,r)):(c.origin=n,c.destination=i,r.setOptions(l),s=new b.maps.DirectionsRenderer,s.setMap(r),s.setPanel(d[0]),T.when(o(c)).fail(y).then(function(e){s.setDirections(e)
})):n||i?n?(insertText(f[0],"missing destination, only the provided origin is displayed"),t.latitude=n.lat(),t.longitude=n.lng(),a(e,t,r)):(insertText(f[0],"missing origin, only the provided destination is displayed"),t.latitude=i.lat(),t.longitude=i.lng(),a(e,t,r)):insertText(f[0],"error: neither origin or destination could be determined")
})}function u(){var t,r,n,i,o,a=M.orientation;-1!==T.inArray("ios",A.features)&&90===Math.abs(e.orientation||0)?(t=e.screen.height,r=e.screen.width):(t=e.screen.width,r=e.screen.height),n=e.innerWidth,i=e.innerHeight,o=n>i?"landscape":"portrait",T.extend(M,{screenX:t,screenY:r,windowX:n,windowY:i,orientation:o}),a&&a!==o&&(log("onOrientationChange(): rotated!"),updateCurrentConfig()),x.trigger("scroll")
}function c(){A.isOnline=k.onLine===!0,log("onNetworkChange(): online="+A.isOnline)
}function l(e){var t,r,n,i,o,a,s,u,c,l,p=T(e.target),f=p.data("action"),d="Check your network connectivity and try again.",g="Are you sure you wish to discard this pending record?",h="Submitting all records may take some time, continue?",y=function(e){var t,r=new T.Deferred,n=e.data("id"),i=n.split(":"),o=i[0],a=i[1],s=i[2];
return C.config["i"+o]?(t=C.config["i"+o].pertinent.name,p.prop("disabled",!0),T.when(M.pendingStore.get(o+":"+a+":"+s)).fail(function(){BMP.alert("Error: unable to retrieve this form"),p.prop("disabled",!1)
...
case"object":i=n}e.addClass("s-working"),T.when(BlinkForms.submitData(t,a,i)).always(function(t,n,i){var u;
i&&"function"===T.type(i.promise)||(u=i,i=t,t=u),p.prop("disabled",!1),200===i.status&&t?M.store&&(clearPendingForm(o,a,s),e.remove()):e.toggleClass("s-working s-error"),r.resolve()
...
})}))})}else i=p.closest('[data-blink="active-form"]'),o=i.data("version"),a=i.data("id"),s=a.split(":"),u=s[0],c=s[1],l=s[2],2===o?"clear"===f?BMP.confirm(g,{title:"Forms Queue"}).then(function(e){e&&T.when(clearPendingForm(u,c,l)).then(function(){i.remove()
})}):"resume"===f?(t="/"+C.answerSpace+"/"+C.config["i"+u].pertinent.name+"/?_uuid="+l,m.pushState({m:currentMasterCategory,c:currentCategory,i:u,arguments:{pendingForm:a}},null,t)):"submit"===f&&y(i):1===o&&("clear"===f?BMP.confirm(g,{title:"Forms Queue"}).then(function(e){e&&T.when(clearPendingFormV1(u,l)).then(function(){i.remove()
})}):"submit"===f&&T.when(M.pendingV1Store.get(u+":"+l)).fail(function(){BMP.alert("Unable to retrieve record from storage.",{title:"Forms Queue"})
...
}function d(){var t=T("#startUp"),r=T("#masterCategoriesView"),n=T("#categoriesView"),i=T("#keywordListView"),o=C.queryParameters._t;
...
}T("#answerSpacesListView").remove(),M.gotoDefaultScreen(),T.when(restoreSessionProfile(o)).always(function(){var e,t=resolveItemName(C.queryParameters.keyword);
...
}).always(function(){T.when(requestLoginStatus()).always(function(){T.when(requestConfig()).always(function(){C.map&&C.config?(processConfig(),d(),Modernizr.orientation&&x.on("orientationchange",u),x.on("resize",u),u()):_.append("error: unable to contact server, insufficient data found in local storage")
})})})}),T.when(e?M.store.get("starsProfile"):!0).then(function(e){"string"===T.type(e)&&(e=T.parseJSON(e)),"object"===T.type(e)&&(starsProfile=e)
}),T("#startUp-initLoaded").addClass("success")}catch(t){log("loaded(): exception:"),log(t),T("#startUp-initLoaded").addClass("error"),_.append("loading error: "+t)
}}function h(){var t,i,o=null,a=[],s=k.userAgent;if(log("init_main(): "),C.requestsCounter=0,PictureSourceType.PHOTO_LIBRARY=0,PictureSourceType.CAMERA=1,lastPictureTaken.image=new Hashtable,lastPictureTaken.currentName=null,T.fx.interval=27,M.dispatch=new BlinkDispatch(isBlinkGapDevice()?149:47),M.runningTasks=0,RegExp.quote=function(e){return e.replace(/([.?*+\^$\[\]\\(){}\-])/g,"\\$1")
...
}),_Blink.isPhantomJS||(x.bind("online",c),x.bind("offline",c),c()),isBlinkGapDevice()?(o=null,t=k.gap_database&&-1!==T.inArray("websqldatabase",BlinkStorage.prototype.available)?r():!0):-1!==s.indexOf("Android")&&(o="sessionstorage"),isBlinkGapDevice()&&M.device.domainWhitelist&&e.navigator.whitelistmanage&&(i=M.device.domainWhitelist,"array"===T.type(i))){log("BlinkGap: replacing domain whitelist...");
try{k.whitelistmanage.appendToWhitelist(T.noop,T.noop,{externalHosts:i})}catch(u){log("BlinkGap: domain whitelist error..."),error(u)
}log("BlinkGap: domain whitelist replaced!")}T.when(t).always(function(){if(M.device.persistentStorage)try{M.store=new BlinkStorage(o,C.answerSpace,"jstore"),a.push(M.store.ready()),M.siteStore=new BlinkStorage(o,C.answerSpace,"site"),a.push(M.siteStore.ready()),M.pendingStore=new BlinkStorage(null,C.answerSpace,"pending"),a.push(M.pendingStore.ready()),M.pendingV1Store=new BlinkStorage(null,C.answerSpace,"pendingV1"),a.push(M.pendingV1Store.ready())
}catch(e){return _.addClass("s-error"),T("#startUp-initMain").addClass("error"),e.toString&&_.children("output").text(""+e),_.children('article[data-name="persistentfull"]').show(),void 0
}T.whenArray(a).fail(function(){throw T("#startUp-initMain").addClass("error"),"initMain(): unable to initialise device storage"
...
}}var m,v,w,b,S=e.document,C=e.siteVars,A=e.deviceVars,M=e.MyAnswers,T=e.jQuery,_=T("#startUp"),k=e.navigator,x=T(e);
...
return Modernizr.geolocation?(e=T.extend({},r,T.isPlainObject(e)?e:{}),k.geolocation.getCurrentPosition(function(e){var r;
...
}).fail(function(){log("init failed, not all promises kept")}),T(S).ready(function(){var t,r=k.userAgent;
...
//@ sourceMappingURL=/_R_/gecko/3/bic2.js.map