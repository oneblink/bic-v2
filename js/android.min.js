...
},m.init()}(window);var activityIndicatorTop,$navBar;document.getElementById("startUp-loadDevice").className="working",MyAnswers.deviceDeferred=new $.Deferred,function(a){var b=a.jQuery,c=function(){var c=this;
...
return c.hideLocationBar(),MyAnswers.dispatch.add(function(){0!==g.size()?g.hide("slide",{direction:h},300,function(){g.css("z-index",""),g.css("position",""),d.css("z-index",""),d.css("position",""),a.updateNavigationButtons(),MyAnswers.$body.children("footer").show(),f.resolve(),d.trigger("viewShow")
