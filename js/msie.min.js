...
populateDataTags(c,d),c.on("click",onStarClick),"object"!==$.type(starsProfile[$(b).data("type")])||"object"!==$.type(starsProfile[$(b).data("type")][$(b).data("id")])?c.addClass("blink-star-off"):c.addClass("blink-star-on"),$(b).replaceWith(c)
