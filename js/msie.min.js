...
});return k}function init_device(){var a=$("#activityIndicator");log("init_device()"),deviceVars.scrollProperty="top",deviceVars.scrollValue="$1px",$navBar=$("#navBoxHeader"),activityIndicatorTop=Math.floor($(window).height()/2),a.css("top",activityIndicatorTop),$("#startUp-initDevice").addClass("success")
