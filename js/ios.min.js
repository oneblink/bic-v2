...
return"screen-bottom"!==a.currentConfig.footerPosition&&MyAnswers.$body.children("footer").hide(),h.size()<1?(e.resolve(),void 0):(MyAnswers.dispatch.pause("prepareView"),i.find("button").attr("disabled","disabled"),h.addClass("animating"),f=setTimeout(function(){h.trigger("webkitTransitionEnd")
...
}),setTimeout(function(){h.addClass("slid"+g)},0),currentMasterCategory?c.attr({"data-name":siteVars.config["m"+currentMasterCategory].pertinent.name}):b("#categoriesView").removeAttr("data-name"),currentCategory?c.attr({"data-name":siteVars.config["c"+currentCategory].pertinent.name}):b("#keywordListView").removeAttr("data-name"),currentInteraction?c.attr({"data-name":siteVars.config["i"+currentInteraction].pertinent.name,"data-type":siteVars.config["i"+currentInteraction].pertinent.type}):(b("#answerView").removeAttr("data-name"),b("#answerView").removeAttr("data-type")),void 0)
