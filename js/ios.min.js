...
return"screen-bottom"!==a.currentConfig.footerPosition&&MyAnswers.$body.children("footer").hide(),h.length<1?(e.resolve(),void 0):(MyAnswers.dispatch.pause("prepareView"),i.find("button").attr("disabled","disabled"),h.addClass("animating"),f=setTimeout(function(){h.trigger("webkitTransitionEnd")
